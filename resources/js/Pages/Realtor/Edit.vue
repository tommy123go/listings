<template>
    <form @submit.prevent="update">
      ...
      <div class="col-span-2">
        ...
        :class="{ 'border-red-600': form.errors.beds }"/>
      ...
      <div class="col-span-2">
        ...
        :class="{ 'border-red-600': form.errors.baths }"/>
      ...
      <div class="col-span-2">
        ...
        :class="{ 'border-red-600': form.errors.area }"/>
      ...
      <div class="col-span-4">
        ...
        :class="{ 'border-red-600': form.errors.city }"/>
      ...
      <div class="col-span-4">
        ...
        :class="{ 'border-red-600': form.errors.street }"/>
      ...
      <div class="col-span-2">
        ...
        :class="{ 'border-red-600': form.errors.street_nr }"/>
